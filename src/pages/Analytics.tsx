...
const topVideos = [
  { title: '10 Minimalist Desk Setup Tips', views: '245K', ctr: '8.4%', watchTime: '5:12' },
  { title: 'iPhone 15 Pro Max Review', views: '180K', ctr: '7.2%', watchTime: '6:05' },
  { title: 'Life of a Software Engineer', views: '120K', ctr: '6.8%', watchTime: '4:30' },
  { title: 'How to use LLMs efficiently', views: '95K', ctr: '9.1%', watchTime: '7:45' },
  { title: 'My 2026 Tech Stack', views: '80K', ctr: '5.5%', watchTime: '3:20' },
];
